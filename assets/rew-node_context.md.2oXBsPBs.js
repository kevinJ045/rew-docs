import{_ as i,c as a,o as n,ah as t}from"./chunks/framework.BVCN9yfE.js";const c=JSON.parse('{"title":"Rew Context","description":"","frontmatter":{},"headers":[],"relativePath":"rew-node/context.md","filePath":"rew-node/context.md"}'),p={name:"rew-node/context.md"};function e(l,s,h,k,r,E){return n(),a("div",null,s[0]||(s[0]=[t(`<h1 id="rew-context" tabindex="-1">Rew Context <a class="header-anchor" href="#rew-context" aria-label="Permalink to &quot;Rew Context&quot;">​</a></h1><p>The rew context is similar to the nodejs context, with a few differences.</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">module</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
